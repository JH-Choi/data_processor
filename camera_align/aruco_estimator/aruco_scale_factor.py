...
from aruco_estimator.read_write_model import write_images_binary, write_points3d_binary, write_cameras_binary
...
class ArucoScaleFactor(ScaleFactorBase):
    ...
    def write_data(self):
        ...
        print('sparse_scaled_path: ', sparse_scaled_path)
        ...
        cameras_scaled_bin = sparse_scaled_path.joinpath('cameras.bin')
        images_scaled_bin = sparse_scaled_path.joinpath('images.bin')
        points_scaled_bin = sparse_scaled_path.joinpath('points3D.bin')

        write_cameras_binary(self.photogrammetry_software.cameras, cameras_scaled_bin)
        write_images_binary(self.photogrammetry_software.images_scaled, images_scaled_bin)
        write_points3d_binary(self.sparse_scaled, points_scaled_bin)
